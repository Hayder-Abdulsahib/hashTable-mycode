...
class HashTable {
    ...
    insert = (student) => {
        ...
        if (classRoom === "A") this.classes.A.push(student)
        else if (classRoom === "B") this.classes.B.push(student)
        else if (classRoom === "C") this.classes.C.push(student)
        else if (classRoom === "D") this.classes.D.push(student)
        else this.classes.Other.push(student)
    }
...
let classCapacity = prompt("Enter the maximum number of students in class");
const classDivided = new HashTable(classCapacity);

students.forEach((student) => classDivided.insert(student))

console.log(classDivided.classes)